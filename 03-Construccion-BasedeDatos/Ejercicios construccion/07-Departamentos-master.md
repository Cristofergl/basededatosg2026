...
Esquema relacional de empresa (Department / Location / Employee / Project / Works_On / Dependent):

> De los departamentos (Department) se almacena:
- Number (Primary Key)
- Name
- Startdate
- Manager (manager_ssn_fk_unique)

> De las ubicaciones (Location) se almacena:
- Numlocation_fk (Primary Key)
- Numberdepartment_fk
- Location
